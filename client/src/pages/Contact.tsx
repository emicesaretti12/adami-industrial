        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          >
            ...
            <motion.div variants={itemVariants}>
              <TiltCard>
                <div className="bg-[#f5f7fa] p-8 rounded-sm border-l-4 border-[#4e6e94] shadow-sm hover:shadow-md transition-shadow h-full">
            ...
            <motion.div variants={itemVariants}>
              <TiltCard>
                <div className="bg-[#f5f7fa] p-8 rounded-sm shadow-sm grid grid-cols-1 sm:grid-cols-2 gap-6 h-full">

  ...
  return (
    ...
    >
      ...
      <main>
        ...
        {/* Contact */}
        <section ref={containerRef} className="py-20 lg:py-24 border-t border-border">
          <div className="container">
            <div className="grid grid-cols-1 lg:grid-cols-[1.3fr,0.7fr] gap-12 lg:gap-20">
              {/* Form */}
              <motion.form
                ...
                {contactInfo.map((info, i) => {
                  ...
                  return (
                    <div key={i} className="flex items-start gap-4">
                      <div className="w-10 h-10 rounded bg-accent/10 flex items-center justify-center shrink-0 mt-0.5">

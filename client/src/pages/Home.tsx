    ...
    <div className="min-h-screen bg-white text-[#1a2b3d] font-sans selection:bg-[#4e6e94] selection:text-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-24 pb-20 overflow-hidden bg-gradient-to-b from-[#f5f7fa] to-white">
        ...
        <div className="absolute inset-0 pointer-events-none overflow-hidden z-0">
          <div className="absolute top-1/4 right-[-5%] w-[40vw] h-[40vw] rounded-full border border-[#e2e8f0] opacity-30" />
          <div className="absolute bottom-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full border border-[#dce4ed] opacity-40" />
          
          <svg className="absolute top-1/3 left-10 w-24 h-24 text-[#6b8db5] opacity-20" viewBox="0 0 100 100" fill="none">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Ingeniería que{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4e6e94] to-[#2c4a6e]">
                transforma
              </span>{' '}
              industrias
            </motion.h1>
            ...
            >
              <Link href="/servicios" className="group inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#4e6e94] text-white rounded-lg font-medium transition-all hover:bg-[#3a5a80] hover:shadow-lg hover:-translate-y-0.5 w-full sm:w-auto">
                Explorar Soluciones
      ...
      {/* 2. STATS SECTION */}
      <section className="py-20 bg-[#f5f7fa] border-y border-[#e2e8f0]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                className="bg-white border border-[#e2e8f0] rounded-xl p-8 hover:shadow-xl hover:border-[#dce4ed] transition-all duration-300 group card-glass"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-white p-6 rounded-xl border border-[#e2e8f0] text-center hover:border-[#4e6e94] hover:-translate-y-1 transition-all duration-300 group shadow-sm hover:shadow-md"
              >
      ...
      {/* 6. CTA SECTION */}
      <section className="py-24 bg-[#4e6e94] relative overflow-hidden">

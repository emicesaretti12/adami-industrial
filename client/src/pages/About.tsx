...
export default function About() {
  return (
    <div className="min-h-screen bg-white text-[#1a2b3d] font-sans selection:bg-[#4e6e94] selection:text-white">
      ...
      {/* Mission & Vision */}
      <section className="py-20 px-6 lg:px-12 bg-[#f5f7fa]">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <motion.div 
              ...
              className="bg-white p-10 rounded-3xl shadow-sm border border-[#e2e8f0] hover:shadow-md transition-shadow"
            >
              <div className="w-14 h-14 bg-[#f5f7fa] rounded-2xl flex items-center justify-center mb-6 text-[#4e6e94]">
                <Target className="w-7 h-7" />
              </div>
              <h2 className="text-3xl font-bold text-[#1a2b3d] mb-4">Nuestra Misión</h2>
              <p className="text-lg text-[#5a6b7c] leading-relaxed">
            ...
            >
              ...
              <h2 className="text-3xl font-bold text-[#1a2b3d] mb-4">Nuestra Visión</h2>
              <p className="text-lg text-[#5a6b7c] leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <motion.h2 
              ...
              viewport={{ once: true }}
              className="text-3xl md:text-5xl font-bold text-[#1a2b3d] mb-6"
            >
              Pilares de Calidad
            </motion.h2>
            <motion.p 
      ...
      <section className="py-24 px-6 lg:px-12 bg-[#f5f7fa]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-bold text-[#1a2b3d] mb-6">Valores Corporativos</h2>
          </div>
          ...
          >
            {values.map((val, idx) => (
              <motion.div key={idx} variants={fadeInUp} className="bg-white p-8 rounded-3xl shadow-sm border border-[#e2e8f0] text-center">
      ...
      {/* Regional Presence */}
      <section className="py-24 px-6 lg:px-12 bg-white border-t border-[#e2e8f0]">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <motion.div 
              ...
              className="lg:w-1/2"
            >
              <h2 className="text-3xl md:text-5xl font-bold text-[#1a2b3d] mb-6">Presencia Regional</h2>
